...
newGolferGroup = groups.filter_by(id=9).one()
newGolfer=PoolGolfers(name='Rafa Cabrera Bello', country='ESP', startingRank=26, group=newGolferGroup)
session.add(newGolfer)
session.commit()
newGolfer=PoolGolfers(name='Kyle Stanley', country='USA', startingRank=31, group=newGolferGroup)
session.add(newGolfer)
session.commit()
newGolfer=PoolGolfers(name='Louis Oosthuizen', country='RSA', startingRank=35, group=newGolferGroup)
session.add(newGolfer)
session.commit()
newGolfer=PoolGolfers(name='Adam Scott', country='AUS', startingRank=41, group=newGolferGroup)
session.add(newGolfer)
session.commit()
newGolfer=PoolGolfers(name='Kevin Na', country='USA', startingRank=45, group=newGolferGroup)
session.add(newGolfer)
session.commit()
